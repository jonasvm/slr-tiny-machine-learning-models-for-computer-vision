...
| 30 | TinyML and IIoT based product quality classification for food industry | 2025 | Conference Paper | IEEE | Todo | Todo |
| 31 | Integrated underwater data transmission and object detection system using tinyml and multi-hop networks | 2025 | Conference Paper | IEEE | Todo | Todo |
| 32 | Optimization of waste management disposal using edge impulse studio on tiny-machine learning (tiny-ml) | 2024 | Conference Paper | IEEE | Todo | Todo |
| 33 | Smart Cattle Behavior Sensing with Embedded Vision and TinyML at the Edge | 2025 | Article | Engineering Proceedings | Todo | Todo |
| 34 | Resource-Constrained intelligent trap: fruit flies surveillance framework with TinyML integration | 2024 | Conference Paper | IEEE | Todo | Todo |
