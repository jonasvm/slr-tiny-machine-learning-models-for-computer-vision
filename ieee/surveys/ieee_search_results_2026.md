...
The items below can be removed immediately from the initial screening table because they are clearly out of scope or are not review papers:
...
These papers are worth manually checking before a final exclusion decision:
...
- Broader surveys on edge computing, hardware acceleration, UAV vision, or domain-specific computer vision even without explicit TinyML focus.

## Remove

- Research articles, benchmarks, or case studies  
- Application-specific implementation papers  
- Surveys focused on topics unrelated to edge AI or computer vision (e.g., 6G/metaverse, networking infrastructure, cybersecurity, LLMs)
